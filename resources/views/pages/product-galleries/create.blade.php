        ...
        <div class="card-body card-block">
            <form action="{{ route('product-galleries.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <br>
                    <label>
                        <input type="radio" name="is_default" value="1" class=" @error('is_default') is-invalid @enderror"/> <br> Ya
                    </label> 
                    &nbsp;
                    <label>
                        <input type="radio" name="is_default" value="0" class=" @error('is_default') is-invalid @enderror"/> <br> Tidak
                    </label>
