    ...
    <div class="card">
        ...
        <div class="card-body card-block">
            <form action="{{ route('products.update', $item->id) }}" method="POST">
                ...
                <div class="form-group">
                    <button class="btn btn-primary col-3" type="submit"><i class="fa fa-pencil"></i> Edit Barang</button>
                    <a href="{{route('products.index')}}" class="btn btn-danger col-3"><i class="fa fa-undo"></i> Kembali</a>
                </div>
            </form>
        </div>
    </div>
