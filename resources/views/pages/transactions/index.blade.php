        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body--">
                        <div class="table-stats roder-table ov-h">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                   ...
                                   @forelse ($items as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @endif
                                            <a href="#mymodal" data-remote="{{ route('transactions.show', $item->id) }}" data-toggle="modal" data-target="#mymodal" data-title="Detail Transaksi" data-title2="{{ $item->uuid }}" class="btn btn-info btn-sm">
                                                <i class="fa fa-eye"></i>
                                            </a>
